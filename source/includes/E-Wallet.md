...
redirect_url_env | String(255) | CONDITIONAL | "web" | Indicates the environment that you use to redirect the customers back once payment has been completed in e-wallet issuers. Possible values: "web" or "app". Only required if ewallet_code is equal to "dana_ewallet"
