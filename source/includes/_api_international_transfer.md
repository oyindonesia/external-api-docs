...
| 400 Bad Request | 990 | Nationality must be 2 characters | Indicates that the nationality parameter contains a value of less than or more than 2 characters. |
| 400 Bad Request | 990 | ID Type is required | Indicates that the id_type parameter is missing from the request or contains an empty or null value. |
| 400 Bad Request | 990 | ID Type is not valid | Indicates that the id_type parameter does not match any valid ENUM value or contains an invalid value (e.g., OY). |
| 400 Bad Request | 990 | ID Number is required | Indicates that the id_number parameter is missing from the request or contains an empty or null value. |
...
| 400 Bad Request | 990 | Country of Incorporation must be 2 characters  | Indicates that the country_of_incorporation parameter contains a value of less than or more than 2 characters. |
...
Parameter | Type | Description
--------- | ---- | -----------
status | Object | Information about the result of the API request. It does not indicate the status of the transaction itself but rather confirms whether the request was successfully processed by the API. <br><br> `{code: <status_code>, message: <status_message>}` <br><br>See [Response Codes & Messages](#response-codes-amp-messages-get-transfer-detail) for more details.
...
| 403 Forbidden | 208 | API Key is not valid | Indicates that the x-api-key Header is either missing from the request or is present but empty. It may also indicate that the provided x-api-key value does not match the one registered in OY\!. |
| 400 Bad Request | 990 | Quotation ID is required | Indicates that the quotation_id parameter is missing from the request or contains an empty or null value. |
| 404 Not Found | 204 | Quotation ID is not found | Indicates that the quotation_id parameter contains a value that either does not exist in the database or has an INITIATED status (whether expired or not). |
| 400 Bad Request | 990 | Send Callback must be either true or false | Indicates that the send_callback parameter contains a non-boolean value. |
| 429 Too Many Requests | 429 | Too Many Requests | Indicates that the Client has sent too many requests within a given period, exceeding the allowed rate limit. |
| 504 Gateway Timeout | 504 | Request Timeout | Indicates that the server does not receive a timely response from an OY\! Service. |
| 500 Server Error | 999 | Oops\! Something went wrong\! Sorry for the inconvenience. \\n The application has encountered an unknown error. \\n We have been automatically notified and will be looking into this with the utmost urgency. | Indicates failures due to an unexpected issue on the server side, including unhandled NPEs and database issues. |
...
Parameter | Type | Required | Description
--------- | ---- | -------- | -----------
type | String(ENUM) | TRUE | Type of Sender Contact. <br><br>**Allowed values**: PERSONAL, BUSINESS
personal_contact | Object | FALSE | Object for Sender Personal Contact information. Required if type = PERSONAL. [See here](#personal-contact-object-for-sender-and-recipient) 
business_contact | Object | FALSE | Object for Sender Business Contact information. Required if type = BUSINESS. [See here](#business-contact-object-for-sender-and-recipient)

### Recipient Contact Details Object

Parameter | Type | Required | Description
--------- | ---- | -------- | -----------
type | String(ENUM) | TRUE | Type of Recipient Contact. <br><br>• **Allowed values**: PERSONAL, BUSINESS <br>• For Destination Country CN (in any available currency), only allow type = BUSINESS.
personal_contact | Object | FALSE | Object for Recipient Personal Contact information. Required if type = PERSONAL. [See here](#personal-contact-object-for-sender-and-recipient) 
business_contact | Object | FALSE | Object for Recipient Business Contact information. Required if type = BUSINESS. [See here](#business-contact-object-for-sender-and-recipient)
bank | Object | TRUE | Object for Recipient Bank information. [See here](#bank-object-for-recipient)

### Personal Contact Object for Sender and Recipient

Parameter | Type | Required | Description
--------- | ---- | -------- | -----------
last_name | String(255) | TRUE | Last Name
date_of_birth | String | TRUE | Date of Birth. Use the format: yyyy-MM-dd.
nationality | String(2) | TRUE | Nationality. Two-letter ISO 3166-2 country code.
id_type | String (ENUM) | TRUE | Identification Type. <br><br>**Allowed values**: passport, nric, unspecified
id_number | String(255) | TRUE | Identification Number
mobile_number_prefix | String(255) | TRUE | Prefix for Phone / Mobile Number. Example: +62, +65.
mobile_number | String(255) | TRUE | Phone / Mobile Number without Prefix. Must be numeric.
address_line | String(255) | TRUE | Address
city | String(255) | TRUE | City
state_or_province | String(255) | TRUE | State / Province
address_country | String(2) | TRUE | Address Country. Two-letter ISO 3166-2 country code.
postal | String(255) | TRUE | Postal Code
first_name | String(255) | FALSE | First Name
middle_name | String(255) | FALSE | Middle Name
other_name | String(255) | FALSE | Other Name
gender | String (ENUM) | FALSE | Gender. <br><br>**Allowed values**: male, female
occupation | String(255) | FALSE | Occupation
country_of_birth | String(2) | FALSE | Country of Birth. Two-letter ISO 3166-2 country code.
email | String(255) | FALSE | Email
residential_status | String(255) | FALSE | Residential Status

### Business Contact Object for Sender and Recipient

Parameter | Type | Required | Description
--------- | ---- | -------- | -----------
business_name | String(255) | TRUE | Business Name
business_reg_number | String(255) | TRUE | Business Registration Number
date_of_incorporation | String | TRUE | Date the Business was registered. Use the format: yyyy-MM-dd.
country_of_incorporation | String(2) | TRUE | Country where the Business is registered. Two-letter ISO 3166-2 country code.
country_of_operation | String(2) | TRUE | Country where the Business is operated. Two-letter ISO 3166-2 country code.
mobile_number_prefix | String(255) | TRUE | Prefix for Phone / Mobile Number. Example: +62, +65.
mobile_number | String(255) | TRUE | Phone / Mobile Number without Prefix. Must be numeric.
address_line | String(255) | TRUE | Address
city | String(255) | TRUE | City
...
address_country | String(2) | TRUE | Address Country. Two-letter ISO 3166-2 country code.
postal | String(255) | TRUE | Postal Code
website | String(255) | FALSE | Website URL for the Business
email | String(255) | FALSE | Email

### Bank Object for Recipient

Parameter | Type | Required | Description
--------- | ---- | -------- | -----------
bank_code | String (ENUM) | TRUE | Bank Code
bank_account_number | String(255) | TRUE | Bank Account Number
bank_account_name | String(255) | TRUE | Name of the Bank Account Holder
bank_address | String(255) | FALSE | Bank Address
...
The following is a list of available Sources of Funds that can be used to create International Transfer API transactions:

| ENUM | Description |
| ----- | :---- |
| BI | Business income |
| CP | Compensation payment |
| DI | Dividend income |
| EI | Employment income |
| IG | Inheritance / Gifts |
| IP | Insurance payout |
| II | Investment income |
| LD | Loan disbursement |
| LO | Loan repaid from others |
| LW | Lottery winnings |
| RI | Rental income |
| SC | Sale of company |
| SI | Sale of investment |
| SP | Sale of property |
| SR | Savings / Retirement funds |

## Purpose of Transfer

The following is a list of available Purpose of Transfer that can be used to create International Transfer API transactions:

| ENUM | Description |
| ----- | :---- |
| BP | Bill payment (utility, tax, medical) |
| EO | Education (others) |
| EF | Education (self) |
| EP | Employee payroll |
| FT | First-party transfer |
| BE | General business expenses |
| LE | General living expenses |
| GD | Gift / Donation |
| IC | Investment (in a company) |
| IS | Investment (in securities) |
| LD | Loan disbursement |
| LP | Loan payment |
| PD | Payment for goods (delivered) |
| PN | Payment for goods (not yet delivered) |
| PS | Payment for services |
| PF | Property purchase / fees |
| PR | Property rental |
| SF | Sending to family member |
| SS | Sending to self |
| SA | Sending to subsidiary / affiliated company |
| TS | Transfer to securities brokerage |
| TE | Travel expenses |
