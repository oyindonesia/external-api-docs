...
|payment_method	|String(255)	|TRUE	|-	|The payment method type that user want to linked to (currently only support `EWALLET`) |
...
|payment_method	|String(255)  |The payment method type that user want to linked to (currently only support `EWALLET`) |
...
payment_method	| String | The payment method type that user want to linked to (currently only support `EWALLET`) |
channel_code	| String | The payment channel type that user want to linked to (currently only support `dana_ewallet`)	|
