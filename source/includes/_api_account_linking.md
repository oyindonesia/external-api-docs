...
|data	|Object	|Account linking data in Object `{partner_user_id: <partner_user_id>, channel_code: <channel_code>, linking_url: <linking_url>}`. The detail will be explained in the next section	|
