...
--------- | ---- | ---------- | -------- | -----------
recipient_bank | String | 3 | TRUE | Bank Code of the Beneficiary account
recipient_account | Numeric | 255 | TRUE | Beneficiary account number
...
recipient_account | Numeric | Account Number of the Beneficiary Account
...
recipient_bank | String | Bank Code of the Beneficiary account
recipient_account | Numeric | Beneficiary account number
