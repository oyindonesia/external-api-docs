...
Use this API to generate a linking URL for your user.
...
After do account linking, user have the capability to see their e-wallet balance. Use this API ti get user e-wallet balance.
