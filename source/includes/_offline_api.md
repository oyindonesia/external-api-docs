...
amount | BigDecimal | TRUE | The amount that going to withdraw or deposit (Only accepts multiple of 50.000 for cash-out transaction)
...
total_amount | BigDecimal | Sum of amount and admin fee
...
* Cancellation is only applicable for **Alfamart Cash-Out & CRM** transactions, Indomaret Cash-In transaction _cannot be cancelled_.
...
* Refresh code is only applicable for **Alfamart Cash-Out & CRM transactions**, Indomaret Cash-In transaction _cannot be refreshed._
