# -*- encoding: utf-8 -*-
# stub: padrino-helpers 0.13.3.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<padrino-support>.freeze, ["= 0.13.3.3"])
      s.add_runtime_dependency(%q<tilt>.freeze, ["< 3", ">= 1.4.1"])
      s.add_runtime_dependency(%q<i18n>.freeze, [">= 0.6.7", "~> 0.6"])
    else
      s.add_dependency(%q<padrino-support>.freeze, ["= 0.13.3.3"])
      s.add_dependency(%q<tilt>.freeze, ["< 3", ">= 1.4.1"])
