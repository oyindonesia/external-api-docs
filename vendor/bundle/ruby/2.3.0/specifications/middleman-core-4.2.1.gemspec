# -*- encoding: utf-8 -*-
# stub: middleman-core 4.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rack>.freeze, ["< 3", ">= 1.4.5"])
      ...
      s.add_runtime_dependency(%q<activesupport>.freeze, ["< 5.1", ">= 4.2"])
      ...
      s.add_dependency(%q<rack>.freeze, ["< 3", ">= 1.4.5"])
